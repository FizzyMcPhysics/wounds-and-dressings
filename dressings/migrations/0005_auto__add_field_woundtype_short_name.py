...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'WoundType.short_name'
        db.add_column(u'dressings_woundtype', 'short_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'WoundType.short_name'
        db.delete_column(u'dressings_woundtype', 'short_name')
