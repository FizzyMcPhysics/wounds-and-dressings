...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Dressing.diabetic_safe'
        db.add_column(u'dressings_dressing', 'diabetic_safe',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Dressing.diabetic_safe'
        db.delete_column(u'dressings_dressing', 'diabetic_safe')
