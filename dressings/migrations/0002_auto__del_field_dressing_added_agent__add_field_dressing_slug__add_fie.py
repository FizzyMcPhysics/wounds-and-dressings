...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Dressing.added_agent'
        db.delete_column(u'dressings_dressing', 'added_agent')

        # Adding field 'Dressing.slug'
        db.add_column(u'dressings_dressing', 'slug',
                      self.gf('django.db.models.fields.CharField')(max_length=30, unique=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Dressing.topical_agent'
        db.add_column(u'dressings_dressing', 'topical_agent',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=10, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Dressing.added_agent'
        db.add_column(u'dressings_dressing', 'added_agent',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=10, blank=True),
                      keep_default=False)

        # Deleting field 'Dressing.slug'
        db.delete_column(u'dressings_dressing', 'slug')

        # Deleting field 'Dressing.topical_agent'
        db.delete_column(u'dressings_dressing', 'topical_agent')
    ...
    models = {
        ...
        u'dressings.dressing': {
            ...
            'topical_agent': ('django.db.models.fields.CharField', [], {'max_length': '10', 'blank': 'True'})
        },
        u'dressings.wound': {
