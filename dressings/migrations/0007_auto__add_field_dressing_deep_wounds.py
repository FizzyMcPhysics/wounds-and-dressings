...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Dressing.deep_wounds'
        db.add_column(u'dressings_dressing', 'deep_wounds',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Dressing.deep_wounds'
        db.delete_column(u'dressings_dressing', 'deep_wounds')
    ...
    models = {
        ...
        u'dressings.dressing': {
            ...
            'body_area': ('django.db.models.fields.CharField', [], {'max_length': '10', 'blank': 'True'}),
            'debriding': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'deep_wounds': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
